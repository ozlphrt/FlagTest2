// ISO 3166-1 alpha-2 codes (lowercase) for the 193 UN member states.
// Source baseline: UN membership list; codes aligned to flagcdn availability.
export const UN193_ISO2: string[] = [
